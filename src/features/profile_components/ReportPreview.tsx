...
import { selectStreakData, selectTotalActiveDays, selectMonthlyStats } from '../habits/store/selectors';
...
function ReportPreview() {
  ...
  const { currentStreak, bestStreak: allTimeBestStreak } = useAppSelector(selectStreakData);
